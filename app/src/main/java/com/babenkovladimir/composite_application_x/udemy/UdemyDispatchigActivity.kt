...
import com.babenkovladimir.composite_application_x.udemy.services.job_intent_service.JobIntentServiceActivity
...
class UdemyDispatchigActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navigateJobIntentService.setOnClickListener { startActivity(Intent(this, JobIntentServiceActivity::class.java)) }
